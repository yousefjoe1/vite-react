        ...
        <div className="bg-black py-8">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center gap-8">
              <img
                src="public/images/versace-logo.svg"
                alt="Versace"
                className="h-8 w-auto"
              />
              <img
                src="public/images/zara-logo.svg"
                alt="Zara"
                className="h-8 w-auto"
              />
              <img
                src="public/images/gucci-logo.svg"
                alt="Gucci"
                className="h-8 w-auto"
              />
              <img
                src="public/images/prada-logo.svg"
                alt="Prada"
                className="h-8 w-auto"
              />
              <img
                src="public/images/calvin-logo.svg"
                alt="Calvin Klein"
                className="h-8 w-auto"
              />
            </div>
