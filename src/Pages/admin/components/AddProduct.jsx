...
const AddProduct = () => {
  ...
  const [colors, setColors] = useState(['black','gray','white','green','blue'])
            ...
            <div className="grid gap-4 grid-cols-3">
                ...
                <div>
                    <Text mb='2px'>category</Text>
                        <Select onChange={(e)=> setCategory(e.target.value)} mb={4} placeholder='Select option'>
                            {
                                categories.map((ctg=>(
                    ...
                    <div>
                        ...
                        <Select onChange={(e)=> setDress(e.target.value)} mb={4} placeholder='Select option'>
                            {
                                dressvalue.map((dr=>(
                    ...
                    <div>
                        ...
                        <Select onChange={(e)=> setSub_category(e.target.value)} mb={4} placeholder='Select option'>
                            {
                                subvalues.map((sb=>(
